...
export const initDB = async (db) => {
  try {
    ...
    console.log('Creating tables within transaction...');
    ...
    for (const sql of migrations) {
      try {
        // Use runAsync for single-statement migrations, it's safer on many Android builds
        await db.runAsync(sql);
        console.log(`Migration checked/applied: ${sql.substring(0, 30)}...`);
      } catch (e) {
